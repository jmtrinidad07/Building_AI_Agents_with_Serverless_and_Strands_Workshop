...
const REDIRECT_URI_VSCODE = "https://d2jkbzym32bewl.cloudfront.net/proxy/8000/callback";
const LOGOUT_URI_VSCODE = "https://d2jkbzym32bewl.cloudfront.net/proxy/8000/login";
...
class Cognito extends Construct {
    constructor(scope, id, props) {
        ...
        const userPool = new cognito.UserPool(this, 'UserPool', {
            userPoolName: 'travel-agent-user-pool-workshop',
        ...
        const userPoolClient = new cognito.UserPoolClient(this, 'UserPoolClient', {
            userPoolClientName: 'travel-agent-client-workshop',
            userPool,
            generateSecret: true,
            authFlows: {
                userPassword: true
            ...
            oAuth: {
                ...
                callbackUrls: [REDIRECT_URI, REDIRECT_URI_VSCODE],
                logoutUrls: [LOGOUT_URI, LOGOUT_URI_VSCODE]
            },
            accessTokenValidity: Duration.hours(8),
            idTokenValidity: Duration.hours(8)
        });

        // Use the existing domain prefix to avoid update conflicts
        const userPoolDomain = userPool.addDomain('UserPoolDomain', {
            cognitoDomain: {
                domainPrefix: `strands-agent-231506`
            }
        });
        ...
        const cognitoSignInUrl = userPoolDomain.signInUrl(userPoolClient, {
            redirectUri: REDIRECT_URI_VSCODE
        });
